    ...
    return (
      <div className="Monsters3">
        <div className="Monsters_None2" id="continu">
          <p>
            Ton morceau de palette te permets de vaincre le terrifiant Dracula
          </p>
          <Link to="/map/Map17">
        ...
        <div className="Monsters_Inputs">
          <div className="Possible_Answers">
            ...
            <div className="Monsters_Input3" id="check3">
              <p className="Monsters_Input_Text">
                Tu appelles Kevin qui le "casse en deux"
              </p>
              <input
                type="checkbox"
                onClick={this.check3}
        ...
        <Jigsaw
          quote={
            "Tu rencontres Dracula dans la maison. Quelle décision prends-tu ?"
          }
        />
      </div>
    );
